...
require (
	...
	github.com/numiadata/tools/pubsub v0.4.0
...
require (
	...
	github.com/cosmos/cosmos-sdk v0.46.13-rc.0 // indirect
...
replace (
	...
	github.com/numiadata/tools/pubsub => ../pubsub

	// this replace can be removed once https://github.com/crypto-org-chain/cronos/blob/f83c74b904cd7e3707146b0b8b380a06c277f239/versiondb/go.mod#LL166C2-L166C75 is removed
